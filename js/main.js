$(document).ready(function () {
	...
	let language = isEn ? "textos-eng" : "textos-span";
	let stickyM = isEn ? "english-sticky" : "spanish-sticky";
	let mainMenu = isEn ? "english" : "spanish";
	let menuHamburguesa = isEn ? "mHEnglish" : "mHSpanish";
	let langSpaEng = isEn ? "langEnglish" : "langSpanish";
	let valida;
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	document.querySelectorAll('nav a:not([href="index.html"]):not([href="index-en.html"])').forEach(anchor => {
	...
	//////////////////////////////////////////////////////////////
	// Envio de correo sin recargar la página (Web3Forms AJAX)
	//////////////////////////////////////////////////////////////
	document.querySelectorAll('form').forEach(form => {
		form.addEventListener('submit', function (e) {
			...
			submitButton.innerText = isEn ? "Sending..." : "Enviando...";
			...
			.then(response => {
				if (response.ok) {
					...
					window.scrollTo({ top: 0, behavior: 'smooth' }); // Te lleva al principio de la pagina
					Swal.fire({
						icon: 'success',
						title: isEn ? "Success!" : "¡Éxito!",
						text: isEn ? "Message sent successfully!" : "¡Mensaje enviado con éxito!",
					...
					Swal.fire({
						icon: 'error',
						title: "Error",
						text: isEn ? "Something went wrong. Please try again." : "Hubo un error. Por favor intenta de nuevo.",
						confirmButtonColor: '#0048FF'
					});
				}
			})
